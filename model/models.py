...
def DRL_prediction(df,
	...
	## trading env
	trade_data = data_split2(df, start=unique_trade_date[iter_num - rebalance_window], end=unique_trade_date[iter_num])
...
def run_ensemble_strategy(df, unique_trade_date, rebalance_window, validation_window) -> None:
	...
	for i in range(rebalance_window + validation_window, len(unique_trade_date), rebalance_window):
		...
		## training env
		train = data_split2(df, start=20090000, end=unique_trade_date[i - rebalance_window - validation_window])
		env_train = DummyVecEnv([lambda: StockEnvTrain(train)])

		## validation env
		validation = data_split2(df, start=unique_trade_date[i - rebalance_window - validation_window],
